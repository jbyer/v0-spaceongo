...
import { CheckCircle, XCircle, MapPin, Building, Calendar, Users, DollarSign } from "lucide-react"
...
export default function AdminPendingApprovalsScreen() {
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t">
                  <Button
                    ...
                    disabled={processingSpaceId === selectedSpace.id}
                  >
                    <XCircle className="h-4 w-4 mr-2" />
                    {processingSpaceId === selectedSpace.id ? "Processing..." : "Reject"}
                  </Button>
                  <Button
                  ...
                  >
                    ...
                    {processingSpaceId === selectedSpace.id ? "Approving..." : "Approve Space"}
                  </Button>
                </div>
              </div>
            </>
